...
void intersec(int array1[],int array2[]){
    ...
    for(int j=array1[0];j<array1[3]+array1[0];j++){
        for(int i=array1[1];i<array1[2]+array1[1];i++){
            array3[j][i]='a';
        }
    }
    for(int k=array2[1];k<array2[3]+array2[0];k++){
        for(int l=array2[0];l<array2[2]+array2[1];l++){
            if(array3[k][l]=='a'){
                array3[k][l]='c';}
            else {
                array3[k][l]='b';
